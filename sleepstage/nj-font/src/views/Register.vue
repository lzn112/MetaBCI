    ...
    <div class="main">
      ...
      <div class="loginbox">
        ...
        <div class="loginbox-in">
          <div class="userbox">
            <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" status-icon>
              <el-form-item label="SmartSleep" style="font-size: larger" class="formContainer1">
                <!--字体放大居中-->
              </el-form-item>
              <el-form-item label="睡眠障碍睡眠分期和评估" class="formContainer2"></el-form-item>
        ...
        <div class="background">
          <div class="title">欢迎使用SmartSleep系统</div>
        </div>
      </div>
    </div>
  </div>
