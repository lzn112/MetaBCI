<template>
  <el-aside width="200px" style="background-color: #0c4f9c; color: aliceblue">
    <el-scrollbar>
      <div style="font-size: 20px; font-weight: bold; margin-bottom: 0px; margin-left: 30px" class="ti">SmartSleep</div>
      <!--居中-->
      <div style="font-size: 16px; margin: 10px; margin-top: 0px">睡眠分期和评估</div>
      <div>
